...
pub use sp_runtime::{Perquintill, Perbill, Permill};
pub mod constants;
...
parameter_types! {
    pub const AssetDeposit: Balance = 100 * ExistentialDeposit;
    pub const ApprovalDeposit: Balance = 1 * ExistentialDeposit;
